...
wall_mat = gr.material({1, 1, 1}, {0, 0, 0}, 10)
floor_mat = gr.material({1, 1, 1}, {0, 0, 0}, 10)
roof_mat = gr.material({1, 1, 1}, {0, 0, 0}, 10)
baoding_mat = gr.new_material({0.0, 0.0, 0.0}, {0.5, 0.7, 0.5}, 25, 0, {0,10})
panel_mat = gr.new_material({0.2, 0.2, 0.2}, {0.5, 0.5, 0.5}, 25, 0.5, {1,10})
table_mat = gr.material({0.5,0.5,0.5},{0.5,0.6,0.5}, 50)
...
Eleanor_base:set_material(mat2)
...
mouse_head:translate(0,0,-2)
mouse_body = gr.cylinder("mouse_body")
mouse_body:scale(1,2,1)
